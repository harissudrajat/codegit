            ...
            <meta charset="utf-8">
                <meta content="IE=edge" http-equiv="X-UA-Compatible">
                    <meta content="width=device-width, initial-scale=1" name="viewport">
                        ...
                        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/plugins/nprogress/nprogress.css" "/>
                        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/plugins/icheck/skins/flat/green.css" "/>
                        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/plugins/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" "/>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="dashboard_graph">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="demo-placeholder" id="placeholder33" style="height: 260px; display: none">
                                    </div>
                                    <div style="width: 100%;">
                                        <div class="demo-placeholder" id="canvas_dahs" style="width: 100%; height:270px;">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="x_panel tile fixed_height_320 overflow_hidden">
                                ...
                                <div class="x_content">
                                    <table class="" style="width:100%">
                                        ...
                                        <tr>
                                            <td>
                                                <canvas height="140" id="canvas1" style="margin: 15px 10px 10px 0" width="140">
                                                </canvas>
                                            </td>
                                            <td>
                                ...
                                <div class="x_content">
                                    <div class="dashboard-widget-content">
                                        ...
                                        <div class="sidebar-widget">
                                            ...
                                            <canvas class="" height="80" id="foo" style="width: 160px; height: 100px;" width="150">
                                            </canvas>
                                            <div class="goal-wrapper">
                                                <span class="gauge-value pull-left">
                                                    $
                                                </span>
                                                <span class="gauge-value pull-left" id="gauge-text">
                                                    3,200
                                                </span>
                                                <span class="goal-value pull-right" id="goal-text">
                                                    $5,000
                                                </span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="weather-icon">
                                                        <canvas height="84" id="partly-cloudy-day" width="84">
                                                        </canvas>
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="row weather-days">
                                                <div class="col-sm-2">
                                                    <div class="daily-weather">
                                                        ...
                                                        <canvas height="32" id="clear-day" width="32">
                                                        </canvas>
                                                        <h5>
                                                            15
                                                            <i>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="daily-weather">
                                                        ...
                                                        <canvas height="32" id="rain" width="32">
                                                        </canvas>
                                                        <h5>
                                                            12
                                                            <i>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="daily-weather">
                                                        ...
                                                        <canvas height="32" id="snow" width="32">
                                                        </canvas>
                                                        <h5>
                                                            14
                                                            <i>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="daily-weather">
                                                        ...
                                                        <canvas height="32" id="sleet" width="32">
                                                        </canvas>
                                                        <h5>
                                                            15
                                                            <i>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="daily-weather">
                                                        ...
                                                        <canvas height="32" id="wind" width="32">
                                                        </canvas>
                                                        <h5>
                                                            11
                                                            <i>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="daily-weather">
                                                        ...
                                                        <canvas height="32" id="cloudy" width="32">
                                                        </canvas>
                                                        <h5>
                                                            10
                                                            <i>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/gauge.js/dist/gauge.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/Flot/jquery.flot.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/Flot/jquery.flot.pie.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/Flot/jquery.flot.time.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/Flot/jquery.flot.stack.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/Flot/jquery.flot.resize.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/flot.orderbars/js/jquery.flot.orderBars.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/flot-spline/js/jquery.flot.spline.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/flot.curvedlines/curvedLines.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/DateJS/build/date.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/jqvmap/dist/jquery.vmap.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/jqvmap/dist/maps/jquery.vmap.world.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/moment/moment.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/datepicker/daterangepicker.js"></script>
        <!-- JAVA END -->
        <!-- Flot -->
    <script>
